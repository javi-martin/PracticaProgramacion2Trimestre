...
public class ConsultaPedido extends Frame implements WindowListener, ActionListener
{
	...
	public void rellenarTextArea(Connection con, TextArea t)
	{
		...
		try {
			...
			while (rs.next()) 
			{
				...
				{
					t.setText(rs.getInt("idPedido")+
							"-"+rs.getString("fechaPedido")+
							", "+rs.getString("subtotalPedido")+
							", "+rs.getString("ivaPedido")+
